  ...
  return (
    <div>
      ...
      onSubmit={handleSubmit}>
        ...
        {name != "" && phone != "" && email != "" ? 
          <button type='submit' style={{display: disp}} className='btn btn-primary '><a onClick={() => {setDis("block"); setDisp("none")}} href={require("./Files/Canterbury_brochure.pdf")} download="Brochure.pdf" className="white">Download</a></button>:<button className='btn btn-primary white'>Download</button>}
